...
const Product4Detail = () => {
  const { handleAddToCart } = useContext(CartContext);

  const product = {
    id: "product4",
    name: "安らぎ与えるミントグリーンハート",
    description: "緑 / ピアス / イヤリング",
    price: 3300,
      ...
      <div className="detail-container">
        <div className="product-section">
          ...
          <div className="text-section">
            ...
            <div className="story">
              <p>
                とろけるミントグリーンカラーのハートビジューをメインに、
                <br />
                ターコイズグリーン・シトラスグリーン・ペールグリーンの3種緑のビジューを添えた見ているだけで癒される組み合わせです。
              </p>
              <p>
          ...
          <div className="recommend">
            ...
            <h4>日常に癒しが欲しい方！</h4>
            <p>
              ハートビジューと、周りの3種のビジューは輝き方が異なります。3色の異なる緑や輝きの違いに目を奪われ、見ているだけで癒されること間違いなしです!
            </p>
          </div>
