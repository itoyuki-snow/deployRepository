      ...
      <div className="detail-container">
        <div className="product-section">
          ...
          <div className="text-section">
            ...
            <div className="story">
              <p>
                ...
                <br />
                ライトローズ・ローズ・ダークローズの3種のローズピンクカラーのビジューでまとめた甘くかわいい組み合わせです。
              </p>
              <p>
                そこに、雨垂れ型の雫クリスタルを使用した純粋さが感じられるデザインに作り上げました。
                <br />
          ...
          <div className="recommend">
            <h3>【こんな方にピッタリです!】</h3>
            <h4>ピンクが好きだけど洋服には取り入れづらいと思っている方！</h4>
            <p>
              コーディネート全体に占める面積が少ないので、主張しすぎることなく、それでもとことんピンクを楽しむことができます。
            </p>
          </div>
